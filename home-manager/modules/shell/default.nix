{
  ...
  programs.fish = {
    ...
    '';
    shellInitLast = "source ${config.age.secrets.SHELL_SECRETS.path}";
  };
  ...
  programs.bash = {
    ...
    bashrcExtra = "source ${config.age.secrets.SHELL_SECRETS.path}";
  };
  ...
  programs.zsh = {
    ...
    enableVteIntegration = true;
    enableCompletion = true;
    initExtra = "source ${config.age.secrets.SHELL_SECRETS.path}";
  };
